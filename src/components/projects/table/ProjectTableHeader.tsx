...
export function ProjectTableHeader({
  ...
  return <TableHeader>
    <TableRow className="bg-muted/50 hover:bg-muted/50 text-xs">
      ...
      <TableHead onClick={() => onSort('contact_name')} className="w-[160px] p-4">
        <div className="flex items-left">Contact {renderSortIndicator('contact_name')}</div>
      </TableHead>
      ...
      <TableHead onClick={() => onSort('package_name')} className="w-[120px] p-4">
        <div className="flex items-left">Package {renderSortIndicator('package_name')}</div>
      </TableHead>
